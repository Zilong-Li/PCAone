...
if [ $platform == "Darwin" ];then
    ...
    make clean && make MKLROOT=/home/zilong/intel/oneapi/mkl/latest STATIC=1 AVX=0 && zip PCAone-x64-Linux.zip PCAone && mv PCAone-x64-Linux.zip $dir && echo "Publishing PCAone_Linux.zip PCAone-x64-Linux.zip done";
    make clean && make MKLROOT=/home/zilong/intel/oneapi/mkl/latest STATIC=1 AVX=1  && zip PCAone-avx2-Linux.zip PCAone && mv PCAone-avx2-Linux.zip $dir && echo "Publishing PCAone_Linux.zip PCAone-avx2-Linux.zip done";

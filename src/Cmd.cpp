...
Param::Param(int argc, char ** argv)
{
    ...
    auto assocnames = opts.add<Value<std::string>>("", "clump-names", "customized column names in assoc-like file for locating chr, pos and pvalue respectively.", "CHR,BP,P", &assoc_colnames);

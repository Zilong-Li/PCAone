...
|--------------------------+-------------------------+-----------+-----------------------------------------|
| Full SVD (-d 3)          | full variance explained | Exact     | slow for big =N= or =M=                     |
| Window-based RSVD (-d 2) | data with =M >> N=        | Very high | fast (only 7 iterations used)           |
| IRAM (-d 0)              | data with =N < 5000=      | Very high | denpends on =N= and # iterations          |
| RSVD (-d 1)              | accuracy insensitive    | High      | depends on # iterations for convergence |
|--------------------------+-------------------------+-----------+-----------------------------------------|
